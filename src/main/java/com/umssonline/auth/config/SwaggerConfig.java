...
public class SwaggerConfig {
    ...
    // API INFO
    private String apiInfoTitle = "Umss Online Auth Service Api Documentation";
    private String apiInfoDescription = "API Rest Docs for Authentication & Authorization service - Umss Online Project";
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                   .apiInfo(apiInfo())
                   .select()
                   .apis(RequestHandlerSelectors.basePackage("com.umssonline.auth.controllers"))
